# Agendo knowledge base

Durable, shared notes about how agendo works — architecture, domain context,
gotchas, and decisions. Meant to survive across machines and help onboard
...
- [Shift drafts](shift-drafts.md) — the draft/published lifecycle, what drafts are excluded from, and the one filter rule that matters
