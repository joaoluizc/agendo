...
export const initialGCalendarEventList: GCalendarEvent[] = [
  {
    ...
    status: "confirmed",
    htmlLink:
      "https://www.google.com/calendar/event?eid=event-id-placeholder-1",
  ...
  },
  {
    ...
    status: "confirmed",
    htmlLink:
      "https://www.google.com/calendar/event?eid=event-id-placeholder-2",
    created: "2024-01-01T00:00:00.000Z",
    updated: "2024-01-01T00:00:00.000Z",
...
export type GCalEventWithGrid = {
  gridStart: number;
  gridSpan: number;
  [key: string]: any;
};

export type UserGCalGrid = {
  userId: string;
